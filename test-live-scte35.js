/**
 * Live HLS Stream SCTE-35 Testing Script
 * 
 * Tests real SCTE-35 injection using the provided HLS stream:
 * Input: https://cloud.itassist.one/khaber24x7live/index.m3u8
 * 
 * This script will test all output formats one by one with actual SCTE-35 injection
 * 
...
async function runLiveTests() {
    console.log('🎬 Live HLS Stream SCTE-35 Testing');
    console.log('====================================');
